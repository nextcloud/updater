OC.L10N.register(
    ...
    "The update was unsuccessful. Please check logs at admin page and report this issue to the <a href=\"https://github.com/owncloud/updater/issues/new\" target=\"_blank\">ownCloud community</a>." : "Η ενημέρωση ήταν ανεπιτυχής. Παρακαλώ ελέξτε το ιστορικό στην σελίδα του διαχειριστή και αναφέρετε το σφάλμα στην <a href=\"https://github.com/owncloud/updater/issues/new\" target=\"_blank\">κοινότητα ownCloud</a>.",
    ...
    "Open Update Center" : "Ανοικτό Κέντρο Ενημερώσεων",
    "Updates" : "Ενημερώσεις",
