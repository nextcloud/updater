OC.L10N.register(
    ...
    "Please note update is possible only to a version that is greater than the one currently installed. If you upgraded from a less stable channel you will be able to upgrade from a more stable channel only after the version that is greater than you installed reaches it." : "Примите к сведению, что обновление возможно только на более позднюю версию, чем установленная. Если вы переключаете канал с менее стабильного на более стабильный, то вы сможете обновить систему в соответствии с новым каналом только после того, как версия в этом канале будет выше установленной.",
