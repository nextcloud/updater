...
"Updates will be available in the updater app and ownCloud admin panel within a few days of an update announcement." => "Обновления будут доступны в приложении для обновления и будут показываться в объявлении в панели администрирования ownCloud.",
"<strong>Up to date.</strong> <em>Checked on {{checkedAt}}</em>" => "<strong>Обновлено.</strong> <em>Проверенно {{checkedAt}}</em>",
"1. Check & Backup" => "1. Проверка и резервная копию",
"2. Download & Extract" => "2. Загрузка и извлечение",
"3. Replace" => "3. Замена",
"Update" => "Обновить",
"Update channel:" => "Канал обновлений:",
"Please note update is possible only to a version that is greater than the one currently installed. If you upgraded from a less stable channel you will be able to upgrade from a more stable channel only after the version that is greater than you installed reaches it." => "Примите к сведению, что обновление возможно только на более позднюю версию, чем установленная. Если вы переключаете канал с менее стабильного канала на более стабильный, то вы сможете обновить систему в соответствии с новым каналом только после того, как версия в этом канале будет выше установленной.",
