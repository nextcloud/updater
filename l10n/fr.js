OC.L10N.register(
    ...
    "<strong>A new version is available: {{newVersion}}</strong>" : "<strong>Une nouvelle version est diponible: {{newVersion}}</strong>",
    "<strong>Up to date.</strong> <em>Checked on {{checkedAt}}</em>" : "<strong>A jour.</strong> <em>Dernière vérification : {{checkedAt}}</em>",
