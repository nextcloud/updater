OC.L10N.register(
    ...
    "Updates will be available here within a few days after the announcement." : "Gli aggiornamenti saranno disponibili qui nel giro di pochi giorni dall'annuncio.",
    ...
    "This app will only backup core files (no personal data)." : "Questa applicazione creerà una copia di sicurezza solo dei file principali (nessun dato personale).",
    "Please always do a separate backup of database and personal data before updating." : "Effettua sempre una copia di sicurezza separata del database e dei tuoi dati prima di aggiornare.",
