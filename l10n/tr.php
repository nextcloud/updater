...
"This app will only backup core files (no personal data)." => "Bu uygulama sadece çekirdek dosyaların yedeklemesini yapar. ( kişisel veriler dahil edilmez )",
"Please always do a separate backup of database and personal data before updating." => "Lütfen, güncelleme yapmadan önce daima veritabanının ve kişisel verilerinizin birer yedeğini ayrı ayrı alın.",
